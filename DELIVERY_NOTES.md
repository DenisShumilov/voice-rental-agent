...
<!-- figures:time -->
**About 4 hours 1 minute of work**, against an eight-hour ceiling.

That is 2 sittings, not a single stretch: 2026-09-14 19:08–23:09, 2026-09-15 14:58–15:18. Counting straight through from the first mark to the last would give 20 hours 10 minutes, but that includes the night in between, and sleep is not work. 20 minutes of an enforced pause on my
AI tooling are subtracted on top of that.

Derived, not remembered: this paragraph is regenerated by `npm run report` from
`git log`, and reads as of that run — 35 commits. A gap longer than
