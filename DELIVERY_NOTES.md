...
<!-- figures:time -->
**4 hours 2 minutes of elapsed wall-clock time**, of which 20 minutes
was an enforced pause on my AI tooling. So about **3 hours 42 minutes of actual
work**, against an eight-hour ceiling.

Derived, not remembered: this paragraph is regenerated by `npm run report` from
`git log`, and reads as of that run: 31 commits ending 23:09 on 2026-09-14,
