...
<!-- figures:time -->
**3 hours 36 minutes of elapsed wall-clock time**, of which 20 minutes
was an enforced pause on my AI tooling. So about **3 hours 16 minutes of actual
work**, against an eight-hour ceiling.

Derived, not remembered: this paragraph is regenerated by `npm run report` from
`git log`. The end is the last commit, 22:44 on 2026-09-14, across 25 commits
