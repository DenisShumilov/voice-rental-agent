...
<!-- figures:time -->
**3 hours 40 minutes of elapsed wall-clock time**, of which 20 minutes
was an enforced pause on my AI tooling. So about **3 hours 20 minutes of actual
work**, against an eight-hour ceiling.

Derived, not remembered: this paragraph is regenerated by `npm run report` from
`git log`. The end is the last commit, 22:48 on 2026-09-14, across 26 commits
...
| | Service | USD / month |
|---|---|---|
| What we pay | Vercel Hobby | $0 |
| | Turso Free | $0 |
| | **Total** | **$0** |
| List price of those same tiers | Vercel Pro | $20 |
| | Turso Developer | $5.99 |
| | **Total** | **$25.99** |

Hosting costs this project nothing: both services have a free tier and this
sits inside both. The brief's rule is that free credits are not zero operating
cost, so the second block is what the same capacity lists at — not a plan to
buy it. Read from vercel.com/pricing and turso.tech/pricing on 2026-09-14.
